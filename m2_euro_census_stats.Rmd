...
The variables needed from dataset are country_code, sex, age, CAS (employment status), EDU (education status),
population of locality of residence (RES_POP) and number of people in each strata (pop). From read_csv:
character - chr (8): COUNTRY_CODE, SEX, AGE, CAS, EDU, FLAGS, FOOTNOTES, RES_POP
numeric - dbl (2): TIME, pop
...
Using the unique function on the country_code variable, there are 32 different countries in the EU
```{r country_code}
